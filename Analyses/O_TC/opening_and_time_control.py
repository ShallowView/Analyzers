...
def O_TC_analysis(list_of_plot_names : list[str]):
    ...
    if (list_of_plot_names.__contains__('O_TC_barplot')):
        barplot_data = get_barplot_data(filtered_data)
        analysis_plot_json_barplot = plot_opening_and_time_control_barplot(barplot_data)
        store_analysis_file('O_TC_analysis',analysis_plot_json_barplot)
    if (list_of_plot_names.__contains__('O_TC_heatmap')):
...
PLOT FUNCTIONS
"""
@assign_plot_to_analysis('O_TC_analysis','O_TC_heatmap')
...
@assign_plot_to_analysis('O_TC_analysis','O_TC_barplot')
...
def get_barplot_data(filtered_games_and_openings_data : pd.DataFrame) -> pd.DataFrame:
    ...
    # print(time_control_percentages_nicer_format.head())
