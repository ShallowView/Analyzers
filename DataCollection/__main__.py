...
# Limits total number of cores used in multiprocessing, by default it's ~80%
# of the cores, reduce if needed
setMaxCores()

addOpeningsToDatabase(lichessOpeningTSVs, db_params_local, tables)

addNewPGNtoDatabase(PGNFiles, db_params_local, tables)
